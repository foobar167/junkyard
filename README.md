...
----------------
### <a name="python_notes" />[Python notes and links to interesting places](scripts_advanced/notes_and_links.md)
...
----------------
### <a name="opencv_tkinter" />[OpenCV + Tkinter snapshot GUI](scripts_advanced/opencv_tkinter.py)
...
----------------
### <a name="dynamic_menu" />[Dynamic menu](scripts_advanced/dynamic_menu.py)
Example of the dynamic menu for Tkinter GUI.

----------------
### <a name="rolling_window" />[Rolling window on NumPy arrays](scripts_simple/rolling_window_on_NumPy_arrays.ipynb)
