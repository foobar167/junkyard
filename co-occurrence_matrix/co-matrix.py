...
if __name__ == u'__main__':
    ...
    d1 = m.descriptor(u'../data-2/doge.jpg')
    d2 = m.descriptor(u'../data-2/doge2.jpg')
    d3 = m.descriptor(u'../data-2/doge3.jpg')
    d4 = m.descriptor(u'../data-2/city.jpg')
    ...
    print(timeit.timeit(stmt=u'm.descriptor(u"../data-2/doge.jpg")', number=n,
