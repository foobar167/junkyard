# Original script is here: https://github.com/Tony607/object_detection_demo/blob/master/resize_images.py
# Use this script to resize your images.
# Save your photos, ideally with jpg extension to ./data/raw directory. Then run,
